...
def startified_random_smaple(dsn, stratas, sample_size):
    """
    parameters
    ...
    freq['pct']=freq['counts']/data.shape[0]
    samp_size_num=(data.shape[0])*sample_size
    ...
    for index,row in freq.iterrows():
        ...
        result = pd.merge(data, freq_bkt, on=stratas)
